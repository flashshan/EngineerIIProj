...
enum EAlignmentXType : uint8_t {
	ELeft,
	ECenter,
	ERight,
};

enum EAlignmentYType : uint8_t {
	ETop,
	EMiddle,
	EBottom,
};
...
namespace eae6320
{
	namespace Application
	{
		...
		public:
			...
			void CalcRectangleVertexDataFromUserInput(EAlignmentXType i_alignmentXType, EAlignmentYType i_alignmentYType,
		...
		private:
			...
			// whether the thread has already started, if not, don't need to stop
